...
export default function ProductTypeTable({ productTypes, onAddProductTypeClick }) {
    ...
    <div className="w-full">
        ...
        <div className="flex flex-col items-end gap-6">
          ...
          <div className="flex items-center gap-4 text-slate-400 bg-white px-4 py-2 rounded-full shadow-sm">
            <div className="relative">
              ...
              <input type="text" placeholder="Buscar tipo de producto..." className="pl-9 pr-4 py-1.5 bg-transparent border-none text-sm focus:outline-none focus:ring-0 w-48" />
            </div>
      ...
      <div className="bg-white/80 backdrop-blur rounded-[24px] p-2.5 shadow-sm border border-slate-100 flex flex-col lg:flex-row gap-3 justify-between items-center mb-6">
        <div className="relative w-full lg:w-[500px]">
          ...
          <input type="text" placeholder="Filtrar por descripción..." className="pl-11 pr-4 py-3 bg-white border border-slate-100 shadow-sm rounded-xl w-full text-sm focus:outline-none focus:ring-2 focus:ring-[#1a4d3a]/20 transition-all font-medium placeholder-slate-400" />
        </div>
      </div>
